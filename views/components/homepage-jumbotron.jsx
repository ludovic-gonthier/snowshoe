...
module.exports = React.createClass({
  render: function () {
    return (
      <div className="jumbotron homepage-jumbotron col-lg-8 col-md-10 col-lg-offset-2 col-md-offset-1">
        <h2>Welcome to <strong>SnowShoe</strong> Dashboards</h2>
        <p className="lead">You can now starts to watch your ongoing Pull-Requests. You can choose to:</p>
