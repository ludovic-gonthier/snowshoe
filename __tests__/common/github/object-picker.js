...
describe('object-picker', () => {
  describe('.pick()', () => {
    it('should return the keys present in a single depth map.', () => {
      ...
      expect(picker(object, map)).toEqual(expected);
    });

    it('should return the keys present in map containing a simple object.', () => {
      const object = {
        a: 42,
        b: 'leet',
        c: 'test',
    ...
    it('should return the keys present in map containing a complex object.', () => {
      const object = {
        first_key: {
          nested_key: {
            deeply_nested_key: [
    ...
    it('should skip not found keys on object', () => {
      const object = {
        first_key: {
          nested_key: {
            deeply_nested_key: [
